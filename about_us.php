     ...
     <div class="row">
       <div class="col-lg-12 col-md-7 d-flex align-items-center">
         <div class="overview-content-2">
           ...
           <p class="peragraph-blog">Billy Shop is a premium HTML template designed and develoved from the ground up with the sole purpose of helping you create an astonishing, the beautiful and user friendly website that will boost your product’s
             sales.</p>
       ...
       <a href="shop.php" class="submit btn-style my-3">shop Now</a>
     </div>
   </div>
 </div>
